                ...
                <div class="example-content">
                    ...
                    <form action="{{ isset($category) ? route("categories.edit", ["id" => $category->id]) : route("category.create") }}" method="POST">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="status" {{ isset($category) && $category->status ? "checked" : "" }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="feature_status" {{ isset($category) && $category->feature_status ? "checked" : "" }}>
                            <label class="form-check-label" for="feature_status">
                                Kategori ana sayfada öne çıkarılsın mı?
                            </label>
                        </div>
